...
`ifdef WARP
`define CY_BLK_DIR "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyControlReg_v1_80"
`include "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyControlReg_v1_80\CyControlReg_v1_80.v"
`else
`define CY_BLK_DIR "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyControlReg_v1_80"
`include "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyControlReg_v1_80\CyControlReg_v1_80.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\or_v1_0"
`include "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\or_v1_0\or_v1_0.v"
`else
`define CY_BLK_DIR "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\or_v1_0"
`include "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\or_v1_0\or_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_PWM_v3_30"
`include "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_PWM_v3_30\B_PWM_v3_30.v"
`else
`define CY_BLK_DIR "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_PWM_v3_30"
`include "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_PWM_v3_30\B_PWM_v3_30.v"
`endif
...
module top ;
	...
	wire [0:0] tmpOE__ButtonRight_net;
	wire [0:0] tmpIO_0__ButtonRight_net;
	wire [0:0] tmpINTERRUPT_0__ButtonRight_net;
	electrical [0:0] tmpSIOVREF__ButtonRight_net;

	cy_psoc3_pins_v1_10
		#(.id("24295bd9-3a0c-47c0-863e-7fc3011905cc"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ButtonRight
		 (.oe(tmpOE__ButtonRight_net),
		  .y({1'b0}),
		  .fb({Net_1110}),
		  .io({tmpIO_0__ButtonRight_net[0:0]}),
		  .siovref(tmpSIOVREF__ButtonRight_net),
		  .interrupt({tmpINTERRUPT_0__ButtonRight_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ButtonRight_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ButtonLeft_net;
	wire [0:0] tmpIO_0__ButtonLeft_net;
	wire [0:0] tmpINTERRUPT_0__ButtonLeft_net;
	electrical [0:0] tmpSIOVREF__ButtonLeft_net;

	cy_psoc3_pins_v1_10
		#(.id("cd9798ce-8ac4-48d7-9cba-4eb3637ac979"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ButtonLeft
		 (.oe(tmpOE__ButtonLeft_net),
		  .y({1'b0}),
		  .fb({Net_1105}),
		  .io({tmpIO_0__ButtonLeft_net[0:0]}),
		  .siovref(tmpSIOVREF__ButtonLeft_net),
		  .interrupt({tmpINTERRUPT_0__ButtonLeft_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ButtonLeft_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_1108 = Net_1105 | Net_1110;
	...
	cy_psoc3_pins_v1_10
		#(.id("5d575d00-5a31-4a7e-97bd-3994841ebd3c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fcf70617-b89d-4355-a9fd-11f54585157c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9236f102-cee4-4c36-a9c7-f4a413bac2ed"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    PWM_v3_30_6 PWM_RGB_RED (
        ...
        .tc(Net_2456),
        .trigger(1'b0));
    defparam PWM_RGB_RED.Resolution = 8;


	cy_clock_v1_0
		#(.id("398a424b-dcd2-4ded-864c-29e8c31ee271"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("125000000"),
		  .is_direct(0),
    ...
    PWM_v3_30_7 PWM_RGB_GREEN (
        ...
        .tc(Net_2516),
        .trigger(1'b0));
    defparam PWM_RGB_GREEN.Resolution = 8;

    PWM_v3_30_8 PWM_RGB_BLUE (
        .capture(1'b0),
        .clock(Net_2336),
        .cmp_sel(1'b0),
        .enable(1'b1),
        ...
        .tc(Net_2564),
        .trigger(1'b0));
    defparam PWM_RGB_BLUE.Resolution = 8;
