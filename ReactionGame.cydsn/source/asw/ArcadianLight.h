...
#ifndef ARCADIANLIGHT_H
#define ARCADIANLIGHT_H
...
//boolean_t AL_isGlowTickDue(uint16_t tickTime_ms, uint16_t reactionTime_ms);

//RC_t AL_calculateGlow(uint8_t* red, uint8_t* green, uint8_t* blue);
