...
void isr_Button1_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)isr_Button1__INTC_NUMBER] = address;
}
...
cyisraddress isr_Button1_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)isr_Button1__INTC_NUMBER];
}
...
{
    *isr_Button1_INTC_PRIOR = priority << 5;
}
...
uint8 isr_Button1_GetPriority(void)
{
    ...
    priority = *isr_Button1_INTC_PRIOR >> 5;
